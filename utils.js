...
share.MailerUtils =
  ...
  readFile: (relativePathFromPrivate) ->
    try
      return Assets.getText(relativePathFromPrivate, encoding: 'utf8')
    catch ex
      throw new Meteor.Error 500, 'Could not find file: ' + relativePathFromPrivate, ex.message